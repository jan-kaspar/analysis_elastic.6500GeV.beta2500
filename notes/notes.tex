...
\subsection[alignment-val]{Validation}
...
%----------------------------------------------------------------------------------------------------
\section[systematics]{Systematic uncertainties}
...
\>> TODO: L-R asymmetry ??
\>> uncertainty values presented in Section~\sref{resolution}, end of bullet on $d_{x,y}$
\>> TODO: validate implementation
