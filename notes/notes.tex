...
\> \plot{acceptance_correction/validation/validation_vs_old.pdf} : comparison of old and new implementations; \TODO: add comment

\> \plot{acceptance_correction/validation/validation_gaussian_approx.pdf} : for the new implementation, comparison of results with and without the gaussian optimisation; \TODO: add comment

\> \plot{acceptance_correction/validation/validation_with_mc.pdf}
