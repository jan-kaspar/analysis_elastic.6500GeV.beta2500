...
%----------------------------------------------------------------------------------------------------
\section[al]{Alignment}

\subsection[al-det]{Determination}
...
\>> 3 leading eigenmodes reproduce the matrix sufficiently well
...
\>>> uncertainty values presented in Section~\sref{al-det}
