...
void Init_45b_56t()
{
	...
	// fiducial cuts
	anal.fc_L_l = FiducialCut(4.4E-6, 0E-6, 0., 0E-6, 0.);
	anal.fc_L_h = FiducialCut(102E-6, 0E-6, 0., 0E-6, 0.);

	anal.fc_R_l = FiducialCut(4.4E-6, 0E-6, 0., 0E-6, 0.);
	anal.fc_R_h = FiducialCut(102E-6, 0E-6, 0., 0E-6, 0.);

	anal.fc_G_l = FiducialCut(4.6E-6, 0E-6, 0., 0E-6, 0.);
...
void Init_45t_56b()
{
	...
	anal.fc_R_l = FiducialCut(4.4E-6, 0E-6, 0., 5E-6, 0.);
	anal.fc_R_h = FiducialCut(102E-6, 0E-6, 0., 0E-6, 0.);

	anal.fc_G_l = FiducialCut(4.6E-6, 2E-6, 0., 5E-6, 0.);
	anal.fc_G_h = FiducialCut(100E-6, 0E-6, 0., 0E-6, 0.);
}
