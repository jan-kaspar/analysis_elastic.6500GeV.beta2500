...
simulations.push("beamDiv");
simulations.push("vertex");
...
{
	NewPad(false);
	label("{\SetFontSizesXX " + s + "}");
}

DrawSet("theta_x_one_pot_hit_LR2F", 1e6, 25, "$\De\th_x^{*,R}\ung{\mu rad}$", 1e6, 25, "$\De\th_x^{*,L}\ung{\mu rad}$");
DrawSet("theta_x_one_arm_regr", 1e6, 5, "$\De\th_x^{*,R}\ung{\mu rad}$", 1e6, 5, "$\De\th_x^{*,L}\ung{\mu rad}$");

DrawSet("theta_y_one_pot_hit_LR2F", 1e6, 1, "$\De\th_y^{*,R}\ung{\mu rad}$", 1e6, 1, "$\De\th_y^{*,L}\ung{\mu rad}$");
DrawSet("theta_y_one_arm_hit", 1e6, 1, "$\De\th_y^{*,R}\ung{\mu rad}$", 1e6, 1, "$\De\th_y^{*,L}\ung{\mu rad}$");
