...
void Init_45b_56t()
{
	...
	anal.cut2_a = 1.; anal.cut2_c = 0.00E-6; anal.cut2_si = 0.39E-6;
	
	anal.cut5_a = 0.157377; anal.cut5_c = -0.000; anal.cut5_si = 0.019;
	anal.cut6_a = 0.156564; anal.cut6_c = -0.012; anal.cut6_si = 0.021;

	anal.cut7_a = -1404; anal.cut7_c = -0.009; anal.cut7_si = 0.20;

	// normalisation settings
	anal.L_int = 7.8715E+04;
}
...
void Init_45t_56b()
{
	...
	anal.cut2_a = 1.; anal.cut2_c = 0E-6; anal.cut2_si = 0.39E-6;

	anal.cut5_a = 0.157855; anal.cut5_c = +0.004; anal.cut5_si = 0.019;
	anal.cut6_a = 0.156146; anal.cut6_c = -0.012; anal.cut6_si = 0.021;

	anal.cut7_a = -1297; anal.cut7_c = -0.002; anal.cut7_si = 0.19;

	// normalisation settings
	anal.L_int = 7.8491E+04;
}
